...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/VTM17eDataLogging.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=ChrFont0.c FillPat.c OledChar.c OledGrph.c PmodOLED.c delay.c i2cLCD.c main.c CANFunctions.c system.c usb_config.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/ChrFont0.o ${OBJECTDIR}/FillPat.o ${OBJECTDIR}/OledChar.o ${OBJECTDIR}/OledGrph.o ${OBJECTDIR}/PmodOLED.o ${OBJECTDIR}/delay.o ${OBJECTDIR}/i2cLCD.o ${OBJECTDIR}/main.o ${OBJECTDIR}/CANFunctions.o ${OBJECTDIR}/system.o ${OBJECTDIR}/usb_config.o
POSSIBLE_DEPFILES=${OBJECTDIR}/ChrFont0.o.d ${OBJECTDIR}/FillPat.o.d ${OBJECTDIR}/OledChar.o.d ${OBJECTDIR}/OledGrph.o.d ${OBJECTDIR}/PmodOLED.o.d ${OBJECTDIR}/delay.o.d ${OBJECTDIR}/i2cLCD.o.d ${OBJECTDIR}/main.o.d ${OBJECTDIR}/CANFunctions.o.d ${OBJECTDIR}/system.o.d ${OBJECTDIR}/usb_config.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/ChrFont0.o ${OBJECTDIR}/FillPat.o ${OBJECTDIR}/OledChar.o ${OBJECTDIR}/OledGrph.o ${OBJECTDIR}/PmodOLED.o ${OBJECTDIR}/delay.o ${OBJECTDIR}/i2cLCD.o ${OBJECTDIR}/main.o ${OBJECTDIR}/CANFunctions.o ${OBJECTDIR}/system.o ${OBJECTDIR}/usb_config.o

# Source Files
SOURCEFILES=ChrFont0.c FillPat.c OledChar.c OledGrph.c PmodOLED.c delay.c i2cLCD.c main.c CANFunctions.c system.c usb_config.c
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/VTM17eDataLogging.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/i2cLCD.o: i2cLCD.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/i2cLCD.o.d 
	@${RM} ${OBJECTDIR}/i2cLCD.o 
	@${FIXDEPS} "${OBJECTDIR}/i2cLCD.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/i2cLCD.o.d" -o ${OBJECTDIR}/i2cLCD.o i2cLCD.c   
...
${OBJECTDIR}/CANFunctions.o: CANFunctions.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/CANFunctions.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/CANFunctions.o.d" -o ${OBJECTDIR}/CANFunctions.o CANFunctions.c   
...
${OBJECTDIR}/i2cLCD.o: i2cLCD.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/i2cLCD.o.d 
	@${RM} ${OBJECTDIR}/i2cLCD.o 
	@${FIXDEPS} "${OBJECTDIR}/i2cLCD.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/i2cLCD.o.d" -o ${OBJECTDIR}/i2cLCD.o i2cLCD.c   
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/VTM17eDataLogging.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk  PIC32_USK_USB_Device_Host_Simple_DEMO_wo_MAL.a  
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mdebugger -D__MPLAB_DEBUGGER_PK3=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/VTM17eDataLogging.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}    PIC32_USK_USB_Device_Host_Simple_DEMO_wo_MAL.a       -mreserve=data@0x0:0x1FC -mreserve=boot@0x1FC02000:0x1FC02FEF -mreserve=boot@0x1FC02000:0x1FC024FF  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,--defsym=_min_heap_size=8192,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/VTM17eDataLogging.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk  PIC32_USK_USB_Device_Host_Simple_DEMO_wo_MAL.a 
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/VTM17eDataLogging.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}    PIC32_USK_USB_Device_Host_Simple_DEMO_wo_MAL.a      -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=_min_heap_size=8192,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"
	${MP_CC_DIR}\\xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/VTM17eDataLogging.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
